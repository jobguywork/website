      ...
      >
          ...
          <div class="answer review-input">
            ...
            <div class="help-block">
              ...
              <ul>
                ...
                <li>توصیه‌ای برای مدیران برای بهتر شدن شرکت بگید</li>
              </ul>
            </div>
            ...
            <el-form-item class="mt-10" prop="cons" label="نکات منفی">
              ...
              <p class="help-block">
                <i class="fa fa-warning ml-5" />
                <span
                  >نکات خود را از لیست بالا انتخاب کن اگر در لیست موجود نبود
                  نکته خود را تایپ کرده و سپس آن را از لیست انتخاب کن.</span
                >
              </p>
            </el-form-item>
          </div>
        ...
        <div class="item p-20 rtl">
          ...
          <div class="answer tell-me">
            ...
            <p class="help-block">
              <i class="fa fa-warning ml-5" />
              <span
                >شغل خود را از لیست بالا انتخاب کن اگر در لیست نبود تایپ
                کن.</span
              >
            </p>
            <div class="layout-h mt-10 mb-20">
              <el-radio-group v-model="form.hiddenJob" class="ltr" size="mini">
                <el-radio-button :label="true"> شغل نمایش نده </el-radio-button>
            ...
            <p class="help-block">
              <i class="fa fa-warning ml-5" />
              <span>شغلی که داشتی دیگران ببینن؟</span>
            </p>
          </div>
        </div>
        ...
        <div class="item terms p-20 rtl">
          <el-checkbox v-model="form.terms">
            ...
            <a href="/terms" target="_blank">قوانین</a> جاب گای باشه، منتشر
            خواهد شد.
          </el-checkbox>
        </div>
      </el-form>
