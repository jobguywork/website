      ...
      >
        ...
        <div class="item p-20 rtl">
          ...
          <div class="answer review-input">
            ...
            <div class="help-block">
              ...
              <ul>
                <li>
                  .از خوبی‌ها و نقاط مثبت کارکردن در این شرکت بگویید و توضیح
                  دهید
                </li>
                <li>
                  اگر بخواهید دوستتان را آگاه کنید که تصمیم بهتری بگیرد، کدام
                  مشکلات قابل توجه این شرکت را گوشزد می‌کنید؟
                </li>
            ...
            <el-form-item class="mt-10" label="تجربه کاری" prop="description">
              ...
              <p class="help-block">
                ...
                می‌توانید با انتخاب قسمتی از متن به آن استایل بدهید (Bold,
                Italic...)
              </p>
              <p style="color: red">
                در ثبت تجربه خود به نکات زیر توجه کنید، در غیر این صورت تجربه
                شما بر روی سایت غیرفعال می‌گردد:
              </p>
              <ul>
                ...
                <li>
                  سعی در بزرگ‌نمایی یا نوشتن موارد غیر واقعی با هدف انتقام‌گیری
                  از شرکت
                </li>
                <li>امکان ویرایش تجربه تنها تا ۳۰ روز فعال می‌باشد.</li>
              </ul>
              <p style="color: red; font-weight: bold">
                نکته: همه شرکت‌ها، حتی شرکت‌های بزرگ هم نقاط ضعفی دارند، پس به
                جای تخریب شرکت سعی کنید فیدبک سازنده بنویسید.
              </p>
              <p style="color: red; font-weight: bold">
        ...
        <div class="item p-20 rtl">
          ...
          <div class="answer tell-me">
            ...
            <p class="help-block">
              <i class="fa fa-warning ml-5" />
              <span
                >شغل خود را از لیست بالا انتخاب کنید و اگر موجود نبود، تایپ
                کنید.</span
              >
            </p>
        ...
        <div class="item terms p-20 rtl">
          <el-checkbox v-model="form.terms">
            در صورتی که تجربه شما در راستای
            <a href="/terms" target="_blank">قوانین جاب گای</a> باشد، منتشر
            خواهد شد.
          </el-checkbox>
        </div>
      </el-form>
